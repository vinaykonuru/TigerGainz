...
class BuddyRequest(models.Model):
    netID=models.CharField(max_length=200,null=True)
    name=models.CharField(max_length=200, null=True)
    major=models.CharField(max_length=200, null=True)
    year=models.CharField(max_length=200, null=True)
    rescollege=models.CharField(max_length=200,null=True)
    days=models.CharField(max_length=300,null=True)
    duration=models.IntegerField(null=True)
    workout_type=models.CharField(max_length=200,null=True)
    time_zone=models.CharField(max_length=200,null=True, default = "EST")
    location=models.CharField(max_length=200,null=True)
    intensity=models.CharField(max_length=200,null=True)
